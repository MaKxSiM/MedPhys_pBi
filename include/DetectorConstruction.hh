...
// Detector parameters
    ...
    const G4ThreeVector pos2 = G4ThreeVector(0, 0, -0.5*cm); // thre third coordinates  gives shift wrt the center of cube
...
//========platic A-150-tissue  with incorporated Bi particles =======================
    ...
    //const G4String env_mat_name = "G4_Au";

    //const G4String Admixture_name = "G4_Bi";
    const G4String Admixture_name = "G4_Au";
    ...
    //G4double  rho_admix = 9.79*g/cm3;// density of bismuth
    G4double  rho_admix = 19.3*g/cm3; // density of gold
    G4double admix_c = 0*mg/L; //concetration in  mg per Litre ++ as per Kolobov++++
    //G4double admix_c = 10000*mg/L; //half of the plate from Bi  ++++test++++
